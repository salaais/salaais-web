...
export const Card = styled.div`
  ...
  padding: ${(props) =>
    props.isShowMore ? "12px 20px 40px 20px" : "12px 20px"};
  background-color: ${(props) =>
    props.isCreatedByMe ? "var(--secondary-color)" : "var(--bg-secondary)"};
  border-radius: 32px;
...
export const ContentIcon = styled.div`
  ...
  cursor: pointer;
  color: ${(props) =>
    props.isCheck ? "var(--primary-color)" : "var(--txt-primary)"};
  font-size: 20px;
