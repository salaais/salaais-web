...
export function TravelCard({ list, type }) {
  ...
  useEffect(() => {
    ...
    isVisited
      ? setVisitedCounter(list.visitedByMe + 1)
      : setVisitedCounter(list.visitedByMe)
  ...
  function handleClickInformation() {
    const informationToCopy = `
      ...
      *Visitado:* ${list.visitedByUser} pessoa(as)
        ...
        <Global.Card isShowMore={isShowMore} isCreatedByMe={isCreatedByMe}>
          <Global.Content>
            ...
            <Global.Icons>
              ...
              <Global.ContentIcon isCheck={isSave} onClick={HandleClickSave}>
                <FontAwesomeIcon
                  icon={isSave ? solidBookmark : regularBookmark}
                />
              </Global.ContentIcon>
            </Global.Icons>
          </Global.Content>
          <Styled.TextContent isShowMore={isShowMore}>
            ...
            <Styled.Flex>
              ...
              <Global.Text>{`${list.visitedByUser} pessoa(as)`}</Global.Text>
            </Styled.Flex>
            ...
            <Styled.IconsInline>
              <Styled.CopyContent isClick={isLink} onClick={handleClickLink}>
                {isLink && (
                  <Styled.CopyText isClick={isLink}>Copiado!</Styled.CopyText>
                )}
              ...
              >
                {isCopy && (
                  <Styled.CopyText isClick={isCopy}>Copiado!</Styled.CopyText>
                )}
                <Styled.CopyIcon icon={faCopy} isClick={isCopy} />
              </Styled.CopyContent>
              <Styled.SwitchContent
                isClick={isAgendedOpen}
                isActive={isAgended}
                onClick={HandleClickAgended}
              >
                {isAgended && (
                  <Styled.CopyText isClick={isAgendedOpen} isActive={isAgended}>
                    Agendado
                  </Styled.CopyText>
                )}
                {!isAgended && (
